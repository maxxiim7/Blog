<div class="navbarleft"> 
            <ul>
                    ...
                    <li><a class="contact" href="/contact"><?= urlIs("/contact") ? "<style>.contact {text-shadow: 0 0 32px turquoise;}</style>" : null; ?><img class="leftimg" src="/img/contactw.png" alt="contact-icon">Contact Us</a></li>
                    </ul>       
</div>